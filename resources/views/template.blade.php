         ...
         <div class="aside-inner">
            <nav class="sidebar" data-sidebar-anyclick-close="">
               ...
               <ul class="sidebar-nav">
                  ...
                  <!-- Gestión de modalidad de graduación -->
                  <li class=" ">
                  ...
                  <li class=" ">
                     <a href="#dashboard10" title="Dashboard" data-toggle="collapse">
                        <em class="icon-briefcase"></em>
                        <span data-localize="sidebar.nav.DASHBOARD">Areas de Cargo Laboral</span>
                     </a>
                     <ul class="sidebar-nav sidebar-subnav collapse" id="dashboard10">
               ...
               <div class="ml-auto">
                  <div class="btn-group"><button class="btn btn-secondary dropdown-toggle dropdown-toggle-nocaret" type="button" data-toggle="dropdown">English</button>
                     <div class="dropdown-menu dropdown-menu-right-forced animated fadeInUpShort" role="menu">
                        ...
                        <a class="dropdown-item" href="#" data-set-lang="es">Spanish</a></div>
                  </div>
